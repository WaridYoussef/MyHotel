<%-- 
    Document   : RespoHoteles
    Created on : 11-avr.-2020, 17:45:16
    Author     : Utilisateur
--%>
...
<html>
    ...
    <body>
       ...
       <%if (session.getAttribute("r") == null) {
            ...
            <form action="/PFE-MyHotel/jsp/AdminResRespo.jsp">
            <div style="text-align: center; margin-top: 30px">
                    <button type="submit" class="btn btn-primary" style="width: 200px">Les reservations...</button>
                    <input type="text" name="idr" hidden value="<%=idr%>">
            </div>
            </form>
                    <h3 style="text-align: center; margin-top: 40px; font-family: monospace; color: #0056b3; ">@Liste hotels</h3>
            ...
            <div style="margin: auto; position: relative; width: 200px">
                <nav aria-label="aller a la page">
                    <ul class="pagination pagination-sm">
                        ...
                        <%} else {%>
                        <li class="page-item"><a class="page-link" href="/PFE-MyHotel/jsp/RespoHoteles.jsp?p=<%=i%>&idr=<%=idr%>"><%=i%></a></li>
                            <%}
                        }%>
                    </ul>

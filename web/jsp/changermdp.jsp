<%-- 
    Document   : changermdp
    Created on : 07-avr.-2020, 17:10:45
    Author     : Utilisateur
--%>
            ...
            <div id="loginbox" style="margin-top: 50px;" class="mainbox col-lg-6 offset-md-3 col-md-8 offset-sm-2">
                <div class="card card-inverse card-info">
                    <div class="card-header">
                        <div class="card-title">Formulaire Changement du mot du passe</div>

                    </div>
                </div>
                <div style="padding-top: 30px;" class="card-block">
                    <div style="display: none;" id="login-alert" class="alert alert-danger col-md-12"></div>
                    <form id="loginform" class="" role="form" method="post" action="/PFE-MyHotel/ChangerMdp">
                        <div class="col-auto">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="password" name="ancmdp" class="form-control" id="inlineFormInputGroup" placeholder="Ancien mot de passe">
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div style="margin-top: 10px;" class="form-group">
                            <!-- Button -->
                            <div class="col-md-12 controls"> <button type="submit" id="btn-login" href="#" class="btn btn-success">Changer le MDP</button>
                                <a id="btn-fblogin"
